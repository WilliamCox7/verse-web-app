...
/**
 * @method scrapeLds this scrapes the scripture from lds.org and saves in db
 * @param {string} query.work the work of the scripture reference
 * @param {string} query.book the book of the scripture reference
 * @param {string} query.chap the chapter of the scripture reference
 * @param {string} query.vers the verse of the scripture reference
 * @returns db insert result
 */
